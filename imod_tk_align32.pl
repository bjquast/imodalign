...
#					   $newtempdir = "\"$newtempdir\""; # =~ s/([^\w\.\/])/\\$1/g;
				       ...
				       &load_tifs($top0, $filearray->{thumbarrayref}, $filearray->{thumbmaxwidth}, $filearray->{thumbmaxheight}, $tempmrc, $tempdir);
...
sub load_tifs {
    ...
    my $resizetext = "-o $maxwidth\,$maxheight";
